...
\topSection
{
	...
	\textbf{Looking for}: Software Development

	\hspace{66pt}Testing/QA
} {
...
Specialties include software development and Linux.
...
\indentedEntry{Jan 2012 - Present}{\textbf{Master's Thesis Collaborator}}
\indentedEntry{Description}{
Technical coordinator for several student master's thesis
...
{
 $\cdot$ A thorough understanding of the C language and the Linux OS, including
associated tools such as ssh, bash, vim, make, gcc, etc.

 $\cdot$  Hands-on experience in Android (Java), iOS
(Objective-C) and web development (Javascript, JQuery, HTML, CSS).

 $\cdot$ Working knowledge of modern development concepts such as version
control (git), cloud computing (OpenStack), design patterns, Continuous
Integration (jenkins), and Test-Driven Development with unit tests and mock
objects.
}
...
\standardEntry{Organizational}
{
 ...
 $\cdot$ Planning and scheduling of team/individual projects using Gantt charts and Getting Things Done\texttrademark.
}
